...
@implementation MetalViewRenderer
{
...
- (nonnull instancetype)initWithMetalKitView:(nonnull MTKView *)mtkView
{
    ...
    if(self)
    {
        ...
        CGFloat viewWidth = mtkView.frame.size.width;
        CGFloat viewHeight = mtkView.frame.size.height;
        AAPLVertex quadVertices[] =
        {
            // Pixel positions, Texture coordinates
            { {  viewWidth,  -viewHeight },  { 1.f, 1.f } },
            { { -viewWidth,  -viewHeight },  { 0.f, 1.f } },
            { { -viewWidth,   viewHeight },  { 0.f, 0.f } },

            { {  viewWidth,  -viewHeight },  { 1.f, 1.f } },
            { { -viewWidth,   viewHeight },  { 0.f, 0.f } },
            { {  viewWidth,   viewHeight },  { 1.f, 0.f } },
        };
